...
export default async function AdminLayout({
  ...
  console.log("[v0] Admin layout - profile query result:", profile, profileError)

  if (!profile || profile?.role !== "admin") {
    console.log("[v0] Admin layout - Access denied, redirecting to /dashboard. Profile:", profile, "Role:", profile?.role)
    redirect("/dashboard")
  }
  console.log("[v0] Admin layout - Access granted for admin user")
