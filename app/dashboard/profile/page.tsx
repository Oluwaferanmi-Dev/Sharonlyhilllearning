      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your account details from the Cherith Training platform</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-slate-900">{profile.department || "Not specified"}</p>
            </div>
          </CardContent>
        </Card>
