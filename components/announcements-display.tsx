    ...
    <div className="space-y-3">
      {visibleAnnouncements.map((announcement) => (
        <Alert key={announcement.id} className="border-blue-200 bg-blue-50">
          ...
          <AlertTitle className="text-blue-900 font-semibold ml-2">{announcement.title}</AlertTitle>
          <AlertDescription className="text-blue-800 ml-6 mt-2">{announcement.message}</AlertDescription>
          <button
